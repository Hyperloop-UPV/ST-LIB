...
struct SdDomain {
    ...
    struct Init {
        ...
        static void init(std::span<const Config, N> cfgs,
            ...
            // Ensure PLL1Q output is enabled (it might be disabled by default if not used by other peripherals)
...
extern "C" inline void HAL_SD_MspInit(SD_HandleTypeDef* hsd) {
