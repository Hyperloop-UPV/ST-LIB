...
void Encoder<dev, pin1, pin2>::turn_on() {
...
template<const TimerDomain::Timer &dev, const ST_LIB::TimerPin pin1, const ST_LIB::TimerPin pin2>
void Encoder<dev, pin1, pin2>::turn_off() {
    if (!is_on) return;
...
template<const TimerDomain::Timer &dev, const ST_LIB::TimerPin pin1, const ST_LIB::TimerPin pin2>
void Encoder<dev, pin1, pin2>::reset() {
    timer->instance->tim->CNT = UINT32_MAX / 2;
}

template<const TimerDomain::Timer &dev, const ST_LIB::TimerPin pin1, const ST_LIB::TimerPin pin2>
uint32_t Encoder<dev, pin1, pin2>::get_counter() {
    return timer->instance->tim->CNT;
}

template<const TimerDomain::Timer &dev, const ST_LIB::TimerPin pin1, const ST_LIB::TimerPin pin2>
bool Encoder<dev, pin1, pin2>::get_direction() {
    return ((timer->instance->tim->CR1 & 0b10000) >> 4);
}

template<const TimerDomain::Timer &dev, const ST_LIB::TimerPin pin1, const ST_LIB::TimerPin pin2>
uint32_t Encoder<dev, pin1, pin2>::get_initial_counter_value() {
    return timer->instance->tim->ARR / 2;
}

template<const TimerDomain::Timer &dev, const ST_LIB::TimerPin pin1, const ST_LIB::TimerPin pin2>
int64_t Encoder<dev, pin1, pin2>::get_delta_clock(uint64_t clock_time, uint64_t last_clock_time) {
